...
# Event Example
This page demonstrates usage of some of the event provided by Alpah Project.
                  ...
                  <div class="evt_dtl_con">
                    <div>
                      ...
                      <style>
                        ...
                        #tabReview1 .tabReview1,
                        #tabReview2 .tabReview1 {
                          position: absolute;
                          left: 0;
                          top: 0;
                          width: 50%;
                        ...
                        #tabReview1 .tabReview2,
                        #tabReview2 .tabReview2 {
                          position: absolute;
                          left: 50%;
                          top: 0;
                          width: 50%;
                        ...
                        .pc #tabReview1 .tabReview1,
                        .pc #tabReview1 .tabReview2 {
                          height: 7%;
                        }
                        .pc #tabReview2 .tabReview1,
                        .pc #tabReview2 .tabReview2 {
                          height: 20%;
                        }
                        #tabReview1 .tabReview3 {
                          position: absolute;
                          left: 9%;
                          top: 32.5%;
                          width: 82%;
                      ...
                      <div class="event-cont-review">
                        <div class="event-section-review visual">
                          <img src="../../public/images/temp/후기이벤트/visual_review.png" alt="" class="pc_show" />
                          <img src="../../public/images/temp/후기이벤트/visual_review_m.png" alt="" class="pc_hide" />
                          <div class="blind">
                            <p>알닷 후기 이벤트 후기만 작성하셔도 시원한 커피를 보내드려요!</p>
                            <p>고객님의 알닷 요금제 경험을 알려주세요 소중한 후기를 남겨 주시면 시원한 커피를 보내드립니다!</p>
                          </div>
                        </div>

                        <div id="tabReview1" class="event-section-review">
                          <img src="../../public/images/temp/후기이벤트/tab_review1_1.png" alt="" class="pc_show" />
                          <img src="../../public/images/temp/후기이벤트/tab_review1_1_m.png" alt="" class="pc_hide" />

                          <a href="#tabReview1" class="tabReview1"><span class="blind">후기는 어떻게 작성하나요?</span></a>
                          <a href="#tabReview2" class="tabReview2"><span class="blind">내가 쓴 후기는 어디서 볼 수 있나요?</span></a>
                          <a href="https://www.umah.lguplus.co.kr/plan/plan-list" class="tabReview3"><span class="blind">알닷 요금제 보러가기</span></a>
                          <a href="https://www.umah.lguplus.co.kr/mypage/rate-manage" class="tabReview4"><span class="blind">평점/후기 남기러 가기</span></a>
                          <div class="blind">
                            <p>후기는 어떻게 작성하나요?</p>
                            <p>고객님께서 알닷의 요금제를 가입하실 때의 개통 경험을 작성해 별점과 함께 작성해 주시면 더 나은 알닷을 만들기 위해 노력할게요.</p>
                            <ol>
                              <li>
                                <p>01 알닷의 요금제를 가입해 주세요.</p>
                                <p>알닷의 다양하고 좋은 요금제 중에서 고객님께 맞는 요금제를 찾아서 가입해 주세요.</p>
                              </li>
                              <li>
                                <p>02 마이페이지에서 평점/후기를 남겨주세요.</p>
                                <p>요금제의 가입과 개통이 완료되셨다면 마이페이지의 사용자 평점/후기 관리로 이동해 주세요.</p>
                                <p>최근에 가입하신 요금제명을 찾아서 [후기등록]을 선택해 주세요.</p>
                              </li>
                              <li>
                                <p>03 별점 평가와 후기를 남겨주세요.</p>
                                <p>개통 과정과 고객상담, 그리고 개통 이후의 만족도에 대해서 별점을 평가해 주세요. 마지막으로 고객님의 소중한 후기를 남겨 주세요.</p>
                                <p>개통 이후 만족하셨나요?</p>
                                <p>어떤점이 좋았나요? 가성비 넘치는 요금제..</p>
                              </li>
                            </ol>
                          </div>
                        </div>

                        <div id="tabReview2" class="event-section-review">
                          <img src="../../public/images/temp/후기이벤트/tab_review1_2.png" alt="" class="pc_show" />
                          <img src="../../public/images/temp/후기이벤트/tab_review1_2_m.png" alt="" class="pc_hide" />
                          <a href="#tabReview1" class="tabReview1"><span class="blind">후기는 어떻게 작성하나요?</span></a>
                          <a href="#tabReview2" class="tabReview2"><span class="blind">내가 쓴 후기는 어디서 볼 수 있나요?</span></a>
                          <a href="https://www.umah.lguplus.co.kr/partners" class="tabReview3"><span class="blind">파트너사 소개 보러 가기</span></a>
                          <div class="blind">
                            <p>내가 쓴 후기는 어디서 볼 수 있나요?</p>
                            <p>고객님께서 작성하신 후기는 선택해 주신 파트너사의 상세화면과 요금제에서 확인할 수 있어요.</p>
                            <ul>
                              <li>
                                <p>파트너사 상세에서 확인하는 법.</p>
                                <p>파트너사 소개에서 파트너사를 선택하시면 리뷰란에서 확인하실 수 있어요</p>
                              </li>
                              <li>
                                <p>요금제 상세에서 확인하는 법</p>
                                <p>고객님이 선택해 주신 파트너사의 요금제 상세의 리뷰란에서도 확인하실 수 있어요</p>
                              </li>
                            </ul>
                          </div>
                        </div>

                        <div class="event-section-review">
                          <img src="../../public/images/temp/후기이벤트/notice_review.png" alt="" class="pc_show" />
                          <img src="../../public/images/temp/후기이벤트/notice_review_m.png" alt="" class="pc_hide" />
                          <div class="blind">
                            <p>유의사항 </p>
                            <ul>
                              <li>후기 등록 이벤트 대상은 개통 완료하신 요금제 당 최초 1회 등록한 내용으로 적용됩니다.</li>
                              <li>후기를 등록하신 시점으로 미납/일시정지/명의 변경 시 이벤트 대상에서 제외될 수 있습니다.</li>
                              <li>비정상적이거나 부정한 방법으로 참여시 지급 대상에서 제외됩니다.</li>
                              <li>당사 사정에 따라 추천 혜택은 사전 예고 없이 조기종료 및 변경될 수 있습니다.</li>
                            </ul>
                          </div>
                        </div>
                      </div>
