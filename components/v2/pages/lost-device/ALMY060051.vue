<template>
  <div class="first-content-item confirm-area paused-complete">
    <div class="content-inner">
      <div class="cont-head">
        <h3 class="cont-title-main">
          일시정지가<br /><strong class="txt-primary">신청</strong>되었어요
        </h3>
      </div>
    </div>

    <p class="icon">
      <img src="/images/v2/content/img_pause_sand_timer.png" alt="모래시계 이미지" />
      <img class="pause-button" src="/images/v2/content/img_pause_button_icon.png" alt="일시정지 버튼 이미지" />
    </p>
