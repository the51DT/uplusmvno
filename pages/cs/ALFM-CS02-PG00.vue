            ...
            <div class="shop_check">
              ...
              <Transition name="mapTooltip">
                <div class="tip" role="tooltip" v-if="showTooltip">
                  <ul>
                    <li class="al">알뜰폰+ : 알뜰폰닷컴 전용 매장이에요. (알뜰폰 CS상담 및 선불유심 개통 가능)</li>
              ...
              <Transition name="mapBottomSheet">
                <div role="region" v-if="bottomSheet">
                  <ul>
                    ...
                    <li>
                      <NuxtLink :to="{}" role="button" class="shop_card" @click="this.$emit('openPopup', ['CS02PO01', 'btn_CS02PO01', 101]);">
                        <div>
                          <!-- 위치 이동 & markup 추가 수정 23/11/02 -->
                          <div class="card_flag">
                            <i class="fla02">CS업무</i>
