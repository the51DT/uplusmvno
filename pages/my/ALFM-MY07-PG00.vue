<template>
  ...
  <div class="container">
    <div class="content" id="content">
        ...
        <div class="eval_wrap">
          ...
          <div class="eval_item">
            ...
            <TextareaBox :data="{
                ...
                value:'금전적으로 충분히 보상할수 있다고 생각합니다~~ 꼭 필요한 알뜰폰으로 옮겨서 통신비 다이어트 해보세요~ 그런데 고객센터가 조금만 더 그런데 고객센터가 조금만 그런데 고객센터가 조금만 친절했음 좋겠어요!',
                maxlength: 1000, byteCheck: true,
              }"
      ...
      <div class="section">
        <div class="btn_group">
          <button type="button" class="btn md c06">삭제하기</button>
          <button type="button" class="btn md c03">수정하기</button>
        </div>
        <div class="btn_group">
...
export default {
  ...
  data(){
    return {
      layout: { header: 'sub', footer: '', floatMenu: '', title: '사용자 평점·후기 상세' },
      dataProduct: [
        {label: '사업자', info:'프리티',},
