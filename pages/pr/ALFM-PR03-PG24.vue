<template>
  ...
  <div class="container">
    <div class="content" id="content">
      ...
      <!-- progress bar 추가 ; 23/11/17 --><!-- component화 ; 23/11/23 -->
      <ProgressBar :barInfo="{type: 'ty02' }" />
      <!-- //progress bar -->

      <div class="page_info">고객님의 신분증과 <br />계좌번호, 신용카드를 준비해 주세요</div>
      ...
      <div class="section">
        <RadioActive
          :data="{
            ...
            data: [
              { checked:false, id:'step01_01', value:`번호이동`, info:'지금 쓰고 있는 내 번호 그대로!', img:'/images/component/img_num_move.png' },
      ...
      <div class="section">
        <div class="box_gray">
          ...
          <ul class="text_list bull">
            <li>신규가입 : <span class="fc01">24시간, 365일 가능</span></li>
...
export default {
  ...
  data(){
    return {
      layout: { header: 'sub2', footer: 'none', title: '요금제 가입 안내', floatMenu: 'none' },
      next: false,
    }
  },
  mounted(){
