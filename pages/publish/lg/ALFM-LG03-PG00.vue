<template>
  <div class="container">
    <div class="content" id="content">
      ...
      <div class="page_info">
        가입하실 <span class="txt-orange">미성년자</span>의<br class="pc_hide" />
        본인인증을 진행해 주세요
      </div>
      ...
      <div class="section">
        ...
        <div class="box_gray mgt20">
          <p><strong>[미성년자 실명인증 안내]</strong></p>
          <p>
            14세 미만 미성년자, 주민등록증 미발급 청소년, 금융거래 실적이 없는 성인 등 실명인증이 안
            되는 분은 신용평가정보회사 사이트에서 직접 실명인증을 등록하신 이후 신청서 작성이
            가능합니다.
          </p>
          <p>
            <NuxtLink to="https://www.niceid.co.kr/name_fowd.nc" target="_blank"
              >실명인증 등록하기 &gt;</NuxtLink
            >
          </p>
        </div>
        ...
        <div class="form_group">
                ...
                <div class="acd_title">
                  <div class="acd_tab">
                    <div class="check_st">
                      <input
                        type="checkbox"
                        id="check_consent05_all"
                        name=""
                        @click="handleAgree"
                      />
                      <label for="check_consent05_all"
          ...
          <div v-if="!acd" class="error">Please agree to the terms and conditions.</div>
        </div>
      </div>
      <!-- // section -->
